...
ShellRoot {
    ...
    function toggleControlBar() {
        if (!controlBarLoader.active) {
            controlBarLoader.active = true;
        } else if (controlBarLoader.item) {
            controlBarLoader.item.openPanel();
        }
    }
    ...
    Loader {
        id: controlBarLoader
        active: false
        source: "modules/controlbar/ControlBar.qml"
        onLoaded: if (item)
            item.openPanel()
    }
    ...
    Variants {
        ...
        Background {
            ...
            onRequestControlPanelLeft: shellRoot.toggleControlBar() // New Signal
        }
    }
