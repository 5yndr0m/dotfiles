...
PopupWindow {
    ...
    readonly property bool mouseInMenu: menuMouseArea.containsMouse
    property alias closeTimer: closeDelay
    ...
    Timer {
        id: closeDelay
        interval: 3000 // Increase from 500 to 1000 (1 full second)
        onTriggered: {
            if (!root.mouseInMenu) {
                root.visible = false;
            }
