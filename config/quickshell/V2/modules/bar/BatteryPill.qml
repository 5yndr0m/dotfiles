...
Item {
    ...
    // Background - Material 3 Surface Container
    Rectangle {
        anchors.fill: parent
    ...
    Row {
        ...
        Text {
            ...
            font.pixelSize: 12
            // Improved contrast logic: if the bar is filled past the halfway point (roughly where text is), use 'on_primary'
