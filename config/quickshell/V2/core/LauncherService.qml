...
Item {
    ...
    // Using a ListModel is much more reactive for asynchronous data
    property ListModel appsModel: ListModel {}

    // This is the property the ListView will bind to
    ...
    Process {
        ...
        onStarted: {
            appsModel.clear();
            console.log("LauncherService: Script started...");
        }

        onExited: code => {
            updateFilter(); // Final pass to ensure everything is caught
            console.log("LauncherService: Finished with " + appsModel.count + " apps.");
        }
    }
}
